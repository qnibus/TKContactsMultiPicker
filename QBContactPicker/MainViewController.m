...
{
    QBContactsMultiPickerController *controller = [[[QBContactsMultiPickerController alloc] initWithNibName:@"QBPeoplePickerController" bundle:nil] autorelease];
    controller.delegate = self;
    [self presentModalViewController:controller animated:YES];
}

#pragma mark - QBPeoplePickerControllerDelegate
...
- (void)contactsMultiPickerController:(QBContactsMultiPickerController*)picker didFinishPickingDataWithInfo:(NSArray*)data
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        [data enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
            ...
            QBAddressBook *ab = (QBAddressBook*)obj;
            ...
            dispatch_async(dispatch_get_main_queue(), ^{                
                QBNameButton *nameButton = [QBNameButton buttonWithType:UIButtonTypeCustom];
                if (personImage)
