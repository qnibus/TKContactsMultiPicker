...
@interface QBContactsMultiPickerController(PrivateMethod)
...
@implementation QBContactsMultiPickerController
...
- (void)viewDidLoad
{
    ...
    {
        QBAddressBook *addressBook = [[QBAddressBook alloc] init];
    ...
    for (QBAddressBook *addressBook in addressBookTemp) {
